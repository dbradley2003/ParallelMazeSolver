...
class MazeSolverBFS : public SkippingMazeSolver
{
public:
	...
	MazeSolverBFS() = delete;
	MazeSolverBFS(const MazeSolverBFS&) = delete;
	MazeSolverBFS& operator=(const MazeSolverBFS&) = delete;
	~MazeSolverBFS() = default;
